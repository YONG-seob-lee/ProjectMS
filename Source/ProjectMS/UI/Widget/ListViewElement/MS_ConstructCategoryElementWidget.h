...
#include "MS_ConstructCategoryElementWidget.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTMS_API UMS_ConstructCategoryElementWidget : public UMS_Widget, public IUserObjectListEntry
{
	GENERATED_BODY()
public:
