...
void AMS_DisplayStorage::OnChangeRequestSlotDatas(const TArray<FMS_SlotData>& aSlotDatas)
{
...
void AMS_DisplayStorage::OnChangeCurrentSlotDatas(const TArray<FMS_SlotData>& aSlotDatas)
{
