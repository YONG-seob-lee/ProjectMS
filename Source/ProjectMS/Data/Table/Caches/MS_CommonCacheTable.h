...
namespace CommonContents
{
	...
	const FString CAMERA_DISTANCE_STRENGTH = TEXT("CAMERA_DISTANCE_STRENGTH");
	const FString MAX_CAMERA_DISTANCE_TOWN = TEXT("MAX_CAMERA_DISTANCE_TOWN");
	const FString MIN_CAMERA_DISTANCE_TOWN = TEXT("MIN_CAMERA_DISTANCE_TOWN");
	const FString MAX_CAMERA_DISTANCE_MARKET = TEXT("MAX_CAMERA_DISTANCE_MARKET");
	const FString MIN_CAMERA_DISTANCE_MARKET = TEXT("MIN_CAMERA_DISTANCE_MARKET");
}
