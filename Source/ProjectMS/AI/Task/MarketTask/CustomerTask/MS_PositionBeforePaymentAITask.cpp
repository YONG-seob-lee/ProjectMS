...
#include "MS_PositionBeforePaymentAITask.h"
...
UMS_PositionBeforePaymentAITask::UMS_PositionBeforePaymentAITask(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	NodeName = "Position Before Payment";
	bNotifyTick = false;
}

EBTNodeResult::Type UMS_PositionBeforePaymentAITask::ExecuteTask(UBehaviorTreeComponent& OwnerComp,
	uint8* NodeMemory)
{
